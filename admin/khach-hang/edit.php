    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <div class="form-check">
                <input <?=!$kich_hoat?'checked':''?> name="kich_hoat" value="0" type="radio" class="form-check-input" id="kich_hoat1">
                <label class="form-check-label" for="kich_hoat1">Chưa kích hoạt</label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input <?=$kich_hoat?'checked':''?> name="kich_hoat" value="1" type="radio" checked class="form-check-input" id="kich_hoat2">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="form-check">
                <input <?=!$vai_tro?'checked':''?> name="vai_tro" value="0" type="radio" lass="form-check-input" id="vai_tro1">
                <label class="form-check-label" for="vai_tro1">Khách hàng</label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input <?=$vai_tro?'checked':''?> name="vai_tro" value="1" type="radio" hecked class="form-check-input" id="vai_tro2">
