    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <div class="form-check">
                <label><input class="form-check-input" name="dac_biet" value="0" type="radio" <?=$dac_biet?'':'checked'?>>Đặc biệt</label>
                <label><input class="form-check-label" name="dac_biet" value="1" type="radio"<?=$dac_biet?'checked':''?>>Bình thường</label>
            </div>
        </div>
        <div class="form-group col-md-4">
