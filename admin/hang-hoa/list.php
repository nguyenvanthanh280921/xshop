    ...
    <body>
            ...
            <nav aria-label="page navigation example" class="text-center" >
                <ul class="pagination" >
                    ...
                    <li class="page-item"><a class="page-link" href="?btn_list&page_no=<?=$_SESSION['page_no']-1?>">&lt;&lt;</a></li>
                    <li class="page-item"><a class="page-link" href="?btn_list&page_no=<?=$_SESSION['page_no']+1?>">&gt;&gt;</a></li>
                    <li class="page-item"><a class="page-link" href="?btn_list&page_no=<?=$_SESSION['page_count']-1?>">&gt;|</a></li>
                </ul>
            </nav>
